...
<div class="floated_img">
   <a href="consearch.php"> <img src="stats2.png" alt="Some image" width="180px" height="80px" style="margin:10px;padding-left:10px;padding-top:50px"></a>
   
</div>
<div class="floated_img">
  <a href="section.php">  <img src="stats3.png" alt="Another image" width="180px" height="80px" style="margin:10px;padding-top:50px"></a>
  
</div>
<div class="floated_img">
   <a href="statistics.php"> <img src="stats1.png" alt="Some image" width="180px" height="80px" style="margin:10px;padding-top:50px"></a>
